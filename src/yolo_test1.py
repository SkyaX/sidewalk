...
def get_subs():
	...
	rospy.Subscriber('/camera/color/image_raw', Image,  process_cam_img)
	rospy.Subscriber('/camera/depth/image_raw', Image,  process_depth_img)
	rospy.Subscriber('/darknet_ros/detection_image', Image,  process_yolo_img, queue_size=2)
	
	rospy.Subscriber('/sidewalk/direction', String,  process_dir)
...
def process_depth_img(depth_image):
...
if __name__ == '__main__':
	rospy.init_node('get_bounding_boxes', anonymous = True)
